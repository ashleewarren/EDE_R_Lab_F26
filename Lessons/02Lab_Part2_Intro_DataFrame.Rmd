...
summary(df) #statistics for each column
head(df) #show the first 6 rows of df
tail(df) #show the last 6 rows
#If you know the number of the column you want you can refer to that to access column
df[,1]

#you could also use this notation to delete columns this deletes the second column and converted to a vector because of square brackets
df <- df[,-2]
df
```
