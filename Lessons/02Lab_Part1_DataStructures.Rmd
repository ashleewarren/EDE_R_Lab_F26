...
#Returns maximum value of vector1
max(vector1)
...
#Bind vector1 and vector4
c(vector1, vector4)

#Multiply vector1 by vector4
vector1 * vector4

#Multiply vector1 by 10
vector1 * 10

#Convert all characters in vector2 to uppercase
toupper(vector2) 
...
#First two objects in list
list1[1:2]

#Change Name to Janelle
list1$name = "Janelle"

#Change Fourth Object Age to 44
list1[[4]] = 44
```
